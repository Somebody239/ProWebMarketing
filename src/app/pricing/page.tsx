  ...
  return (
    <main>
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 -bottom-24 hero-gradient bg-gradient-to-b from-background via-background/80 to-transparent"></div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Our pricing is straightforward and affordable - no hidden fees or surprises.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  answer: "No, the prices you see are all-inclusive. We believe in transparent pricing with no surprises."
                },
                {
